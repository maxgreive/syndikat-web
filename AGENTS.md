...
- Run `npm run build:assets` after Svelte/CSS changes and `npm run build` before submitting site changes. The latter also verifies the Eleventy production build.
