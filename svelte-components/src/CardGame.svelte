<script>
  ...
  const labels = {
    de: {
      ...
      privacy: "Dieses statische Demo nutzt lokalen Speicher und BroadcastChannel fuer Tabs auf diesem Geraet. Fuer echte getrennte Handys braucht es die API und Datenbank aus dem Projektplan.",
    ...
    en: {
      ...
      privacy: "This static demo uses local storage and BroadcastChannel for tabs on this device. Real separate-phone play needs the API and database from the project plan.",
